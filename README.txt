...
Для ознакомлением с кодом задачи и кодом тестов открыть "...\effective-mobile\Effective Mobile\Effective Mobile.sln" с помощью Visual Studio и просматреть соответствующие проекты.
